...
protected:
	...
	glm::vec2 hitboxDimensions = glm::vec2(0.5*30.f/64.f, 31.f/64.f); //dimensione della hitbox rispetto al centro della sprite p.e. per una 64x64 -> (15,20), cioè una hitbox 30x40, con centro position + vec(0.5)
